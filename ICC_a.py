        ...
        for atlas in atlases:
            ...
            for p_idx in range(0,num_pair):
                ...
                #for duration_col in [duration10]:
                    ...
                    #fileout=outpath + '/disc_files/Random-'+ str(ses_select)+'_Pipeline-'+str(p_idx) + '_Ses_'+str(col_indx)+'.txt' 
                    ...
                    for i in range(0,plotrange):
                        for j in range(i+1,len(pipelines)):
                            ...
                            if bootstrapping_ci == True: # this will plot the mean spatial correlation and plot the co=nfident interval
                                ...
                                print(pp)
                                #fileout=outpath + '/CI_files/Random-'+ str(ses_select)+'_Pipeline-'+str(p_idx) + '_Ses_'+str(col_indx)+'.txt' 
...
# minimal
pipelines_list=[
    ['cpac_default_no_nuisance','cpac_default_no_nuisance','different'],
    ['cpac_fmriprep','cpac_fmriprep','different'],
    ['fmriprep','fmriprep','different'],
    ['fmriprep','cpac_default_no_nuisance','different'],
    ['fmriprep','cpac_fmriprep','different'], 
    ['fmriprep','cpac_default_no_nuisance','same'],
    ['fmriprep','cpac_fmriprep','same'],
    ['fmriprep','fmriprep','same'],
    ['cpac_default_no_nuisance','cpac_default_no_nuisance','same'],
    ['cpac_fmriprep','cpac_fmriprep','same']
    ]
### all
pipelines_list=[
    ['cpac_default_no_nuisance','fmriprep','different'],
    ['cpac_fmriprep','fmriprep','different'],
    ['cpac_fmriprep','cpac_default_no_nuisance','different'],
    ['XCP_CPAC_default','XCP_fmriprep','different'],
    ['XCP_CPAC_FX_2mm','XCP_fmriprep','different'],
    ['XCP_CPAC_FX_2mm','XCP_CPAC_default','different'],
    ['XCP_fmriprep','CPAC_default_Allnew','different'],
    ['XCP_fmriprep','CPAC_FX_2mm_Allnew','different'],
    ['cpac_default_no_nuisance','fmriprep','same'],
    ['cpac_fmriprep','fmriprep','same'],
    ['cpac_fmriprep','cpac_default_no_nuisance','same'],
    ['XCP_CPAC_default','XCP_fmriprep','same'],
    ['XCP_CPAC_FX_2mm','XCP_fmriprep','same'],
    ['XCP_CPAC_FX_2mm','XCP_CPAC_default','same'],
    ['XCP_fmriprep','CPAC_default_Allnew','same'],
    ['XCP_fmriprep','CPAC_FX_2mm_Allnew','same']
    ]

pipelines_list=[
    ['cpac_default_no_nuisance','fmriprep','different'],
    ['CPAC_fMRIPrep_MNI2006_2mm_Allnew','fmriprep','different'],
    ['CPAC_fMRIPrep_MNI2006_2mm_Allnew','cpac_default_no_nuisance','different'],
    ['XCP_CPAC_default','XCP_fmriprep','different'],
    ['XCP_CPAC_fMRIPrep_MNI2006_2mm','XCP_fmriprep','different'],
    ['XCP_CPAC_fMRIPrep_MNI2006_2mm','XCP_CPAC_default','different'],
    ['XCP_fmriprep','CPAC_default_Allnew','different'],
    ['XCP_fmriprep','CPAC_FX_MNI2006_2mm_Allnew','different'],
    ['cpac_default_no_nuisance','fmriprep','same'],
    ['CPAC_fMRIPrep_MNI2006_2mm_Allnew','fmriprep','same'],
    ['CPAC_fMRIPrep_MNI2006_2mm_Allnew','cpac_default_no_nuisance','same'],
    ['XCP_CPAC_default','XCP_fmriprep','same'],
    ['XCP_CPAC_fMRIPrep_MNI2006_2mm','XCP_fmriprep','same'],
    ['XCP_CPAC_fMRIPrep_MNI2006_2mm','XCP_CPAC_default','same'],
    ['XCP_fmriprep','CPAC_default_Allnew','same'],
    ['XCP_fmriprep','CPAC_FX_MNI2006_2mm_Allnew','same']
    ]

## filter after nuisance
pipelines_list=[
    ['cpac_default_no_nuisance','fmriprep','different'],
    ['CPAC_fMRIPrep_MNI2006_2mm_Allnew','fmriprep','different'],
    ['CPAC_fMRIPrep_MNI2006_2mm_Allnew','cpac_default_no_nuisance','different'],
    ['XCP_Nuisance_before_filter_CPAC_default','XCP_Nuisance_before_filter_fmriprep','different'],
    ['XCP_Nuisance_before_filter_CPAC_fMRIPrep_MNI2006_2mm','XCP_Nuisance_before_filter_fmriprep','different'],
    ['XCP_Nuisance_before_filter_CPAC_fMRIPrep_MNI2006_2mm','XCP_Nuisance_before_filter_CPAC_default','different'],
    ['XCP_Nuisance_before_filter_fmriprep','CPAC_default_Allnew','different'],
    ['XCP_Nuisance_before_filter_fmriprep','CPAC_FX_MNI2006_2mm_Nuisance_before_filter_Allnew','different'],
    ['cpac_default_no_nuisance','fmriprep','same'],
    ['CPAC_fMRIPrep_MNI2006_2mm_Allnew','fmriprep','same'],
    ['CPAC_fMRIPrep_MNI2006_2mm_Allnew','cpac_default_no_nuisance','same'],
    ['XCP_Nuisance_before_filter_CPAC_default','XCP_Nuisance_before_filter_fmriprep','same'],
    ['XCP_Nuisance_before_filter_CPAC_fMRIPrep_MNI2006_2mm','XCP_Nuisance_before_filter_fmriprep','same'],
    ['XCP_Nuisance_before_filter_CPAC_fMRIPrep_MNI2006_2mm','XCP_Nuisance_before_filter_CPAC_default','same'],
    ['XCP_Nuisance_before_filter_fmriprep','CPAC_default_Allnew','same'],
    ['XCP_Nuisance_before_filter_fmriprep','CPAC_FX_MNI2006_2mm_Nuisance_before_filter_Allnew','same']
    ]
...
pipelines_list=[
    ['XCP_Nuisance_before_filter_fmriprep','XCP_Nuisance_before_filter_CPAC_fMRIPrep_MNI2006_2mm','same'],
    ['XCP_Nuisance_before_filter_fmriprep','XCP_Nuisance_before_filter_CPAC_fMRIPrep_MNI2006_2mm','different'],
    ]
'''
...
for ppp in allpl:
    for f in os.listdir(base + '/ROI_Schaefer1000/' + ppp):
        file=base + '/ROI_Schaefer1000/' + ppp + '/' + f
        print(file)
